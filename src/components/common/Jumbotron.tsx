...
const Jumbotron = ({ children }: { children: ReactNode }) => {
    return <div className="min-h-[40dvh] mt-[75px] py-12 w-full bg-primary dark:bg-primary-dark flex lg:flex-row flex-col items-center justify-center lg:gap-16 gap-8">
