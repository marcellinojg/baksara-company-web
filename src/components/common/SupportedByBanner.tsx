...
const SupportedBy = () => {
    ...
    return <Fade>
        <div className="bg-navbar-light text-primary lg:flex-row flex-col py-[5vh] px-[10%] w-10/12 mx-auto floating-shadow-lg rounded-lg flex items-center justify-between">
            <b className="text-4xl font-family-secondary text-center font-bold lg:pb-0 pb-8">{translate('Fully Supported by')}</b>
