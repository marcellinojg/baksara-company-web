...
const SupportedBy = () => {
    ...
    return <Fade>
        <div className="bg-navbar-light text-primary lg:flex-row flex-col py-[5vh] px-[10%] w-10/12 mx-auto floating-shadow-md rounded-lg flex items-center justify-between">
